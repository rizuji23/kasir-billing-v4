...
class List_StokMasuk extends React.Component<any, any> {
    ...
    getDataMasuk() {
        ipcRenderer.invoke("getStokMasuk").then((result) => {
...
class List_StokMasukContainer extends React.Component<any, any> {
    render(): React.ReactNode {
        return (
            <>
...
export default List_StokMasukContainer;