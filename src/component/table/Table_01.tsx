...
class Table_01 extends React.Component<any,any> {
        ...
        ipcRenderer.on(this.state.table_id, (event, msg) => {
            ...
            if (msg.reponse === true) {
                if (msg.mode === 'loss') {
                    ...
                    if (msg.data.split(':')[0] !== '00') {
                        if (msg.data.split(':')[1] === '01') {
                            const data_booking = {
                                nama: this.state.nama,
                                durasi_booking: this.state.jam_add,
                                total_harga: this.state.total_harga_add,
    ...
    render(): React.ReactNode {
        ...
        if (this.state.isUse === false) {
            modal = <ModalBooking table_name={this.state.table_name} handleMode={this.handleMode} handleJam={this.handleJam} startTimer={this.startTimer} close={this.state.modal_close} handleNama={this.handleNama} disableSubmit={this.state.disabled} harga_detail={this.state.harga_detail} total_harga={this.state.total_harga} jam={this.state.jam} handleBlink={this.handleBlink} table_id={this.state.table_id} isOpen={this.state.isOpen} closeModal={this.closeModal} mode_loss={this.state.mode_loss} />
        } else if (this.state.isUse === true) {
            modal = <ModalBookingActive table_name={this.state.table_name} name_customer={this.state.nama} id_booking={this.state.id_booking} table_id={this.state.table_id} stopTimer={this.stopTimer} close={this.state.modal_close} handlePindah={this.handlePindah} jam={this.state.jam_add} harga_detail={this.state.harga_detail} total_harga_add={this.state.total_harga_add} handleJam={this.handleJamAdd} isOpen={this.state.isOpen} closeModal={this.closeModal} handleBlinkAdd={this.handleBlinkAdd} addOn={this.addOn} disabled_add={this.state.disabled_add} resetTable={this.resetTable} mode={this.state.mode} time_running={this.state.time_running} />
        }
